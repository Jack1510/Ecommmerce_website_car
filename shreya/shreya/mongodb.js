...
mongoose.connect("mongodb+srv://lahanearnavslahane:krishna123@cluster0.w9cx3to.mongodb.net/shreya?retryWrites=true&w=majority")
.then(()=>{
...
const buynowSchema = new mongoose.Schema({
    ...
    selectcar: {
        type: String,
        required: true,
        enum: ['titan_strike', 'cyclone_x1', 'nebula_glide', 'pheonix_pulse', 'viper_wave', 'electra_fury', 'aurora_spire', 'turbo_blitz', 'supra', 'raptor_x', 'velocity_gt']
    },
    phone: { 
        type: String, 
        required: true 
...
const bookingSchema = new mongoose.Schema({
    ...
    selectaservice:{
        type:String,
        required:true,
        enum: ['Diagnostic Test', 'Engine Servicing', 'Tire Replacement',"Vacuum Cleaning"] 
    },
    date:{
        type:String,
        required:true
